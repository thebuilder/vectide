...
<dialog id="help-dialog" aria-labelledby="help-title">
  ...
  <details><summary>Jumps, weight shifts and pickups</summary>
    ...
    <p>During a stunt, hold a direction to keep rotating. Release it near upright to settle; the opposite direction brakes the rotation. Extra airtime allows multiple turns.</p>
