...
export const COURSE_LAYOUTS = {
  ...
  storm: {
    ...
    route: [
      [-112, -45],
      // Open water ahead of the grid leads into one broad sweep.
      [-112, -5],
      [-112, 35],
      [-112, 60],
      [-95, 94],
    ...
    land: [
      ...
      island('East breakwater', 142, 20, 34, 80, 9, 'rock'),
    ...
    zones: [
      ...
      zone('West wave train', -65, 114, 1, 0.15, 108, 66, 0.1, 1.4, 29, 5),
