...
export const COURSE_LAYOUTS = {
  palms: {
    ...
    land: [
      island('Crescent island', 50.0, -50.0, 65.0, 107.5, 7),
      island('Reef headland', 171.0, -57.5, 47.5, 75.0, 8),
      island('Outer island', 184.0, 85.0, 102.5, 102.5, 9),
      island('Lagoon island', 47.5, 72.0, 67.5, 135.0, 16),
      island('West shore', -87.5, 77.5, 37.5, 80.0, 6),
      island('Lookout point', 252.5, -32.5, 50.0, 62.5, 13),
      island('Outer reef', 317.5, 75.0, 50.0, 125.0, 8),
    ...
    zones: [
      ...
      zone('Reef wave channel', 288, 57.5, -0.2, -1, 145, 70, 0.2, 2.0, 30, 5),
