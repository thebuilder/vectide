...
- Native Chromium using Metal completed real six-racer laps: Palm 58.27 s and Port 63.45 s. Both visited every gate with zero missed-gate retries, recoveries, rider ejections, or page errors. Both measured a 16.7 ms 95th-percentile animation frame interval.
